...
const MUTATIONS: readonly Mutation[] = [
  ...
  {
    name: "exports: a types branch promising nothing is left in the manifest",
    file: "src/exports.ts",
    from: /if \(!inside \|\| checkerFinds\(names, value\) !== "javascript"\) return value;/,
    to: "return value;",
  },
  {
    name: "exports: a repaired types branch still refuses the publish",
    file: "src/exports.ts",
    from: /rule: "types-branch-not-declarations",\s+consequence: "breaks",\s+healed: true,/,
    to: 'rule: "types-branch-not-declarations", consequence: "breaks", healed: false,',
  },
  {
  ...
  {
    name: "exports: types is hoisted over a key that already leads to declarations",
    file: "src/exports.ts",
    from: /if \(ahead\.some\(reached\)\) return value;/,
    to: "",
  },
  {
  ...
  {
    name: "declared: the declaration beside a target stops counting",
    file: "src/declared.ts",
    from: /return beside \? "declarations" : "javascript";/,
  ...
  {
    name: "declared: a non-script types target is rewritten like JavaScript",
    file: "src/declared.ts",
    from: /if \(!SCRIPT\.test\(target\)\) return "other";/,
    to: "",
  },
  {
